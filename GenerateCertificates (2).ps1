...
.DESCRIPTION
	Following a number of request by Michel Laforge, DBA in the Canadian Infrastructure team, the initial
	intention of this script was to provide an easy and error free creation method of certificates used by
	SQL Enhanced Always On Availability Groups. 
...
.PARAMETER Template
	CA Template to use for the certificate creation. Default is PBWebServer.
.PARAMETER Town
...
.REVISIONS
	2017/08/12 - Martin Thomas - Added this header. Added a step to enable the user to modify the INF before proceeding with the certificate request. Correct a bug in the certificate removal from the local store.
